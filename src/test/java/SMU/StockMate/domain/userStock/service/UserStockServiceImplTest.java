...
import SMU.StockMate.domain.userStock.service.command.v0.UserStockServiceBasic;
...
class UserStockServiceImplTest {
    ...
    @InjectMocks
    UserStockServiceBasic userStockService;
    ...
    void buy_stock_not_enough_balance() throws Exception{
        ...
        // when, then
        assertThatThrownBy(() -> userStockService.buy(tradingRequest, "poor"))
    ...
    void buy_new_stock_with_enough_balance() throws Exception{
        ...
        when(userStockRepository.findByUserIdAndStockCode(1L, "카카오"))
                .thenReturn(Optional.empty());
        when(stockRepository.findByStockCode("카카오")).thenReturn(Optional.of(mockStock));
        ...
        // when
        userStockService.buy(tradingRequest, "test");
    ...
    void sell_success() throws Exception{
        ...
        // when
        userStockService.sell(tradingRequest, "test");
    ...
    void sell_fail_not_found() throws Exception{
        ...
        // when, then
        assertThatThrownBy(() -> userStockService.sell(tradingRequest, "test"))
                .isInstanceOf(CustomException.class)
    ...
    void sell_fail_not_enough_quantity() throws Exception{
        ...
        // when, then
        assertThatThrownBy(() -> userStockService.sell(sellRequest, "test"))
                .isInstanceOf(CustomException.class)
